...
import { tagType, indonesiaFlag } from "../assets";
...
const FundCard = ({
  ...
  return (
    <div
      ...
      onClick={handleClick}>
      <img src={image} alt="fund" className="w-full h-[157px] rounded-[15px]" />
      <div className="flex flex-col p-4">
        ...
        <div className="flex items-center mt-[20px] gap-[12px]">
          ...
          <p className="font-epilogue flex-1 font-normal text-[12px] text-[#808191] truncate">
